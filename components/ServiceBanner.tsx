  ...
  return (
    <div className="not-prose my-10 rounded-2xl bg-gradient-to-br from-brand-800 via-brand-900 to-brand-950 text-white p-6 md:p-8 shadow-lg border border-brand-700/30 overflow-hidden relative">
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-5 md:gap-8">
        ...
        <div className="flex-shrink-0"><Link href={`/services/${service.slug}/`} className="inline-flex items-center gap-2 bg-white text-brand-900 font-bold text-sm py-3 px-6 rounded-xl hover:bg-brand-50 transition-colors shadow-md whitespace-nowrap">Find Investigators <ArrowRight className="w-4 h-4" /></Link></div>
      </div>
    </div>
  );
}
