...
export default function ServiceLocationPage({ params }: { params: { serviceSlug: string; locationSlug: string } }) {
  ...
  const content = serviceLocationContent[service.id] || serviceLocationContent['surveillance'];
  const intro = content.intro(cityName);
  const steps = content.steps(cityName);
  const whyPoints = content.whyPoints(cityName);

  const benefits = [
    { icon: <Award className="w-6 h-6" />, title: 'NYS-Licensed Investigators', desc: `Every investigator in our network holds a current NYS license, carries professional liability insurance, and has a documented case track record.` },
    { icon: <Clock className="w-6 h-6" />, title: 'Response Within 24 Hours', desc: `Most investigators in our network respond within 24 hours and offer a free confidential consultation to discuss your case.` },
    { icon: <Shield className="w-6 h-6" />, title: 'Licensed and Insured', desc: `A current NYS PI license and professional liability insurance are required from every investigator before we refer any cases.` },
    { icon: <Users className="w-6 h-6" />, title: 'Matched to Your Case Type', desc: `We connect you with investigators who have specific experience with your case type — infidelity, corporate, custody, or asset cases each require different expertise.` },
  ];
      ...
      <main className="flex-grow">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-6">
              <div>
                ...
                <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                  {service.title.toLowerCase()} investigators available in {cityName}. Free confidential consultation, no obligation.
                </p>
                <div className="space-y-4 mb-8">
                  {[
                    `${service.title} specialists in ${cityName}, verified and active`,
                    'Up to two matched investigators, each offering a free confidential case consultation',
                ...
                <div className="flex items-center gap-4 text-sm text-gray-400">
                  ...
                  <span>Highly rated by Manhattan clients</span>
                </div>
              </div>
              <div>
        ...
        <div className="container-width py-16">
            ...
            <aside className="lg:col-span-1">
              <div className="sticky top-28 space-y-8">
                ...
                <div className="bg-brand-900 text-white p-6 rounded-2xl shadow-lg">
                  ...
                  <p className="text-brand-100 text-sm mb-4">Retainer-based billing with transparent hourly rates. Investigators provide cost estimates before work begins.</p>
          ...
          <div className="bg-brand-900 rounded-2xl p-8 md:p-12 text-center mt-12">
            ...
            <p className="text-brand-200 mb-8 max-w-2xl mx-auto">Submit your inquiry in under two minutes. We will match you with a licensed {cityName} investigator with no obligation until you choose to proceed.</p>
